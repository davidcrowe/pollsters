...
{
    public abstract class VoteCastWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VoteCastWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VoteCastWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VoteCastDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VoteCastDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VoteCastDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VoteCastDbContext, Task<T>> func)
        {
            T result;
